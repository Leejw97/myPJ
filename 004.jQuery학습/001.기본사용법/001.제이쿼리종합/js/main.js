        ...
        .click(function () {
            ...
            */
            ...
            mi.animate({
                    top: tgtop + "px",
                    left: tgleft + "px"
                }, 1000, "easeInCirc", // 이징 (이름점확히, UI 있어야 함)
                function () { // 콜백함수(애니후)
                    ...
                    $(".heli").animate({
                        ...
                        .animate({
                            ...
                            function () { // 콜백함수
                                ...
                                // 13. 미리 지정한 class를 타이틀에 줘서 간판 떨어짐
                                // 대상: .tit
                                let tit = $(".tit");
                                ...
                                // toggleClass(클래스명) - 클래스 넣기/지우기
                                // -> JS의 classList 객체의 add, remove, toggle과 유사
